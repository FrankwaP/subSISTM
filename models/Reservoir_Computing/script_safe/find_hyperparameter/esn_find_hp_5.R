...
print("5 dataset")
lsdataDates <- fct_load_data_find_hp_e()
##### META PARAMETERS
...
##### SAVE RESULTS
fct_save_results(subDir = paste0("data/multiple_input_scaling_5_", slar_jobid),
...
##### SAVE RESULTS
fct_save_results(subDir = paste0("data/common_input_scaling_5_", slar_jobid),
                 slar_taskid = slar_taskid,
                 object = dfres)
