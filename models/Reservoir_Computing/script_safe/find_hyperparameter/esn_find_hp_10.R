...
print("10 dataset")
lsdataDates <- fct_load_data_find_hp_j()
##### META PARAMETERS
...
##### SAVE RESULTS
fct_save_results(subDir = paste0("data/multiple_input_scaling_10_linked_", slar_jobid),
...
##### SAVE RESULTS
fct_save_results(subDir = paste0("data/common_input_scaling_10_linked_", slar_jobid),
                 slar_taskid = slar_taskid,
                 object = dfres)
