...
##### load data
ls_files_results <- list.files("data/results_forecast_testset_13541192/", full.names = TRUE)
...
# saveRDS(df_forecast_aggregated, "data/forecast_MAR_SI.rds")
saveRDS(object = list(plot_present_data = plot_present_data,
        ...
        file = "data/precomputed_results_MNAR.rds")