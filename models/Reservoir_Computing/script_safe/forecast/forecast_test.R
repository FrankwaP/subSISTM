...
##### LOAD DATA
data_covid <- readRDS(file = "data/random_filled_30.rds")
##### COMMON PARAMETERS
forecast_days = 14
warmup = 30
units = 500
...
importance = TRUE
##### LOAD BEST HP SETS
hp_sets = list(common_input_scaling = "data/common_input_scaling_14315956/",
               common_input_scaling_linked_source = "data/common_input_scaling_linked_14320509/",
               multiple_input_scaling = "data/multiple_input_scaling_14315956/",
               multiple_input_scaling_linked_source = "data/multiple_input_scaling_linked_14320509/"
               ) %>%
...
##### SAVE
message("--------- SAVE ----------")
fct_save_results(subDir = paste0("results_forecast_testset_", slar_jobid),
