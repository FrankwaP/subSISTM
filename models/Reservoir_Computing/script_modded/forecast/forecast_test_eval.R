...
##### load data
ls_files_results <- list.files("data/results_forecast_testset_1_13489898/", full.names = TRUE)
...
df_obfuscated_epidemio <- readRDS("data/missing_data/df_obfuscated_epidemio.rds")
...
saveRDS(df_forecast_aggregated, "data/forecasts/forecast_1.rds")
saveRDS(object = list(plot_present_data = plot_present_data,
        ...
        file = "data/precomputed_results_1.rds")